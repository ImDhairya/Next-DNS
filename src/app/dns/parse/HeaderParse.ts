...
import {TDNSHeader} from "../parts/headers";
import {DNSClass, IDNSQuestion} from "../parts/question";

class DNSParser {
  static parseHeader(buffer: Buffer): TDNSHeader {
  ...
  static parseQuestion(buffer: Buffer, offset: number): IDNSQuestion {
    let qname = "";
    ...
    // return {qname, qtype, qclass, nextOffset: offset + 5};
  }
}
